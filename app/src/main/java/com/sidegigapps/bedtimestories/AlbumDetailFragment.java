...
import com.sidegigapps.bedtimestories.dummy.DummyContent;

/**
 * A fragment representing a single AlbumPrototype detail screen.
...
public class AlbumDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.album_detail)).setText(mItem.details);
        }
