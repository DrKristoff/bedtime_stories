...
public class BaseSignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    BaseSignInActivity baseSignInActivity;
                ...
                if (user != null) {
                    ...
                    if(!Once.beenDone(Once.THIS_APP_SESSION,userSignedIn)){
                        if (!Once.beenDone(Once.THIS_APP_INSTALL, setupCompleted)) {
                            startActivity(new Intent(BaseSignInActivity.this, AlbumListActivity.class));

                            //mark as done on confirmation that setup is complete, not here
                            //Once.markDone(setupCompleted);
                        } else {
                            //startActivity(new Intent(BaseSignInActivity.this, ChoreListActivity.class));
                        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(BaseSignInActivity.this, R.string.auth_failed,
    ...
    public void navigateTo(String page){
        ...
        switch(page){
            case SignInActivity:
                intent = new Intent(BaseSignInActivity.this, SignInActivity.class);
                startActivity(intent);
                break;
/*            case SetupActivity:
                intent = new Intent(BaseSignInActivity.this, SetupActivity.class);
                startActivity(intent);
                break;
            case TodayActivity:
                intent = new Intent(BaseSignInActivity.this, ChoreListActivity.class);
                startActivity(intent);
                break;
            case CalendarActivity:
                intent = new Intent(BaseSignInActivity.this, CalendarActivity.class);
                startActivity(intent);
                break;*/
